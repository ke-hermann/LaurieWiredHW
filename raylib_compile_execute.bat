...
g++ -o %NAMEPART%.exe %FILENAME% mazegen.cpp moeka.cpp %RAYLIB_RES_FILE% -s -O2 -I%RAYLIB_INCLUDE_DIR% -L%RAYLIB_LIB_DIR% -lraylib -lopengl32 -lgdi32 -lwinmm -Wall -mwindows
:: .
:: > Executing program
:: -------------------------
